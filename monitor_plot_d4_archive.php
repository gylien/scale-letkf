...
date_default_timezone_set('UTC');
  ...
  $nowU = strtotime($basetime) + intval($time_offset);
...
$TimeUJMARadarOldest=$TimeUXleft;
$TimeUJMARadarLatest=$TimeUXright;
$TimeUintv=$TimeUJMARadarOldest-$TimeUXleft;
$TimeUlength=$TimeUJMARadarLatest-$TimeUJMARadarOldest;


$Xloc=$Xleft+($TimeUintv / $CycleSecond * $Xsize);
$Yrect = $Yrecb + $YsizeIntv ;
$Yrecb = $Yrect + $YsizeBar ;
 ImageFilledRectangle($image,$Xloc,$Yrect,$Xloc+($TimeUlength / $CycleSecond * $Xsize),$Yrecb,$limegreen);
 ImageRectangle($image,$Xloc,$Yrect,$Xloc+($TimeUlength / $CycleSecond * $Xsize),$Yrecb,$gray);
...
$TimeULatest=max($TimeUFcstLatest,$TimeUJMARadarLatest);
