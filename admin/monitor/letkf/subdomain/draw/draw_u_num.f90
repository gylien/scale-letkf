...
character*30::cfile_a='../data_inv/u_anal.txt'
character*30::cfile_g='../data_inv/u_gues.txt'

character*30::ctitle1='U'
character*30::ctitle2='(m/s)'

character*30::psfile='../temp_figs/u_letkf'
...
!    call swiset('IFL',4) !!! PDF
      ...
      vpl=0.17; vpr=0.92; vpb=0.50 ; vpt=0.73
...
!      call grfrm 
      ...
      vpl=0.17; vpr=0.92; vpb=0.23 ; vpt=0.46
      call grsvpt (vpl,vpr,vpb,vpt) ! set viewport
...
!      call grfrm 
      ...
      vpl=0.17; vpr=0.92; vpb=0.10 ; vpt=0.20
      call grsvpt (vpl,vpr,vpb,vpt) ! set viewport
