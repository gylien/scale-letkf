...
rundir=${realtimebase}/scale_${scale_ver}/scale-letkf_${letkf_ver}/scale/run_d1_ext

initdir=${realtimebase}/result/${expname}/d1
bdytmpdir=${realtimebase}/result/${expname}/ncepgfs_grads_ext
...
if ((res == 0)); then
  ...
  echo "$now [ERR ] $TIMEPRINT - Exit code: $res" >> $logfile
