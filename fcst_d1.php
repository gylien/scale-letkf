...
###
 ...
 $json_xloc = file_get_contents('json/xlocs.json' );
 $json_yloc = file_get_contents('json/ylocs.json' );
 $json_itime = file_get_contents('json/itimes.json' );
...
<title>Model forecasts quicklook for domain 1</title>
...
<div align="left" style="position:relative; top:0px; left:0px;">
  <img id="monitor_campus" src="./monitor/monitor_plot_d1.png" style="margin:0px;"> 
