...
VARS='"U", "V", "T", "QV", "QHYD", "DENS", "PREC", "MSLP", "Gprs", "PW", "ENGT", "ENGP", "ENGI", "ENGK", "MSE" , "Uprs"
, "Vprs", "Tprs", "Gprs", "QVprs","QHYDprs"'
...
&PARAM_SNOPLGIN_HGRIDOPE
 ...
 SNOPLGIN_hgridope_lat_start = 27.0,
 SNOPLGIN_hgridope_lat_end = 42.0,
 SNOPLGIN_hgridope_dlat = 0.1,
 SNOPLGIN_hgridope_lon_start = 125.0,
 SNOPLGIN_hgridope_lon_end = 145.0,
 SNOPLGIN_hgridope_dlon = 0.1,
/
