...
!--------Local Parameters
    ...
    complex*16 eice,ewat,eair !ice, water, and air permittivity
    complex*16 ei     !effective ice-air permittivity
    complex*16 emelt,emelt_wi,emelt_iw, emelt_em !effective water-ice-air permittivity
...
!     lam=(n0*pi*dens/wc)**(0.25)
    ...
    lam = 3.0e+0/2.0e+0/(re*1e-6)  ![1/m]
    n0 = (lam**4)  * wc_unit * 1e-3 / (const_pi*dens) ![1/m4]
!debug
!write(6,*)'lam',lam
!write(6,*)'n0',n0
!debug
    ...
    ! size loop
    do i = 0, imax
      rad = dr*0.5+dr*float(i) ![mm]
      xd  = dble(2.*const_pi*rad/wave)
      ! num is in terms of radius - factors of 2 account for conversion d(D) = 2d(r)
      num = 2.*n0*exp(-lam*2.*rad*(1.e-3))  ![1/m4]
      ...
      eicere=dble(eicered)
      eiceim=dble(eiceimd)
      eice=dcmplx(eicere,eiceim)
      eair=dcmplx(1.0006_r_size,0.0_r_size)
!debug
!write(6,*)'rad',rad
!write(6,*)'xd',xd
!write(6,*)'freqd',freqd
...
!debug
      ...
      bext=bext+num*qext*const_pi*rad*rad*dr*1.e-6
      bsca=bsca+num*qsca*const_pi*rad*rad*dr*1.e-6
      bsym=bsym+num*qsca*asym*const_pi*rad*rad*dr*1.e-6
      bq11=bq11+num*qbsca*const_pi*rad*rad*dr*1.e-6
!debug
!write(6,*)'bext',bext
!write(6,*)'bsca',bsca
!write(6,*)'bsym',bsym
...
! 
 ...
 !complex*8 :: gamma, q
 complex*16,intent(in) :: ematrix ! permittivity of matrix
 complex*16,intent(in) :: eincl   ! permittivity of inclusions
 complex*16,intent(out) ::  emg   !  effective permittivity
 complex*16 :: gamma, q
...
!----local parameter-------
      real(r_size),parameter:: a0=6.107799961e0
      real(r_size),parameter:: a1=4.436518521e-1
      real(r_size),parameter:: a2=1.428945805e-2
      real(r_size),parameter:: a3=2.650648471e-4
      real(r_size),parameter:: a4=3.031240396e-6
      real(r_size),parameter:: a5=2.034080948e-8
      real(r_size),parameter:: a6=6.136820929e-11
...
!
     ...
     qext = dble(qextd)   !extinction efficiency 
     qsca = dble(qscad)   !scattering 
     asym = dble(asymd)   !asymetry
     qbsca= dble(qbscad)  !backscattering
