...
#         qv[l-1] = ldata[2] # water vapor mixing ratio (g/kg)
         u[l-1] = ldata[1]  # zonal wind (m/s)
         v[l-1] = ldata[2]  # meridional wind (m/s)

#   u[z>10000] = np.nan
#   v[z>10000] = np.nan

#   SOUNDING = {"z":z, "pt":pt, "qv":qv, "u":u, "v":v, "psfc":psfc, "ptsfc":ptsfc, "qvsfc":qvsfc}
   SOUNDING = {"z":z, "u":u, "v":v}
...
def hodograph(top, mems):
  ...
  for m in range(mems+1):
     ...
     print("draw ",mem)
     input = os.path.join(top,mem + "_zuv.txt")
...
top = "/work/hp150019/f22013/SCALE-LETKF/scale-LT/OUTPUT/2000m_NODA_1022_FIR2km/prof"
mems = 80
#mems = 1
