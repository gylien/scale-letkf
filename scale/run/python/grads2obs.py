...
CZ_l = [250, 750, 1250, 1750, 2250, 2750, 3250, 3750, 4250, 4750, 
...
def prep_rand(rfn,mu,sigma):
   ...
   if OVERW:   
     tmp1d = np.random.normal(mu, sigma, NVAR * ZMAX * YMAX * XMAX)
     rand3d = np.reshape(tmp1d, (NVAR,ZMAX,YMAX,XMAX))
     np.savez(rfn,rand3d)
   else:
