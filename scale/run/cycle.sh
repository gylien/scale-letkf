...
#distribute_da_cycle 2 1 machinefile
##distribute_fcst '0003 0005 mean' 2 1 1 1 machinefile
#exit
...
echo " +----------------------------------------------------------------+"
echo
echo "  Start time:           ${STIME:0:4}-${STIME:4:2}-${STIME:6:2} ${STIME:8:2}:${STIME:10:2}"
...
#  if [ "$SHAREDISK" = '0' ]; then
#    echo "  Local disks are used to store runtime files"
#  else
