...
SCALE_V=scale-5.1.1
EXP="JAXA2_D2_171012" #Finish

# !! [!--IO_LOG_BASENAME--] should no be specified !!
#

#
SWDIR=/scratch/hp120282/k03117/obssim2
...
SCALE_CONF=${DTOP}/out/${EXP}/20150802000000/log/fcst_scale/mean_run.conf
TOPO=${DTOP}/out/JAXA2_D2_171012/const/topo

#
tstart='2015-08-02 0:00:00'
tend='2015-08-02 0:00:00'
