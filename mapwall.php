...
#$prods_f[3] = '850hPa [theq+Wind] 700hPa [RH]'; ### summer
$prods_f[3] = '850hPa [T+RH+Wind]'; ### winter
...
<title>SCALE-LETKF experimental real-time forecasts</title>
...
function change_rtime() {
  if (isload) {
    ...
    var prod_obj = document.getElementById('prod') ;
//    location.href = 'index.php?prod=' + prod_obj.value + '&rtime=' + rtime_obj.value + '&vtime=' + vtime_obj.value + '&verify=' + verify + '&anim=' + is_animation ;
    location.href = 'mapwall.php?rtime=' + rtime_obj.value + '&vtime=' + vtime_obj.value ;
  }
}
...
<div align="left">
  <p class="p_title">SCALE-LETKF experimental real-time forecasts</p>
</div>
